    ...
    <header class="mobile">
        ...
        <h1 style="color:white; text-align:center; margin-top:10px;">Alunos</h1>
            ...
            <div class="overflow">
              ...
              echo '<td>
              <a href="delete.php?id='.$row['idUsuarios'].'&tipo='.$row['tipo_usuario'].'"
                 onclick="return confirm(\'Tem certeza de que deseja deletar? Essa ação irá excluir permanentemente.\');">
