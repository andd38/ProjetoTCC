        ...
        <h1 style="color:white; text-align:center; margin-top:10px;">Alunos</h1>
            ...
            <div class="overflow">
              ...
              if(isset($_POST['pesquisa'])){
                ...
                echo '<td> <a href="delete.php?id='.$row['idUsuarios'].'&tipo='. $row['tipo_usuario'] .'"><svg style="color:red;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
